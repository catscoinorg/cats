...
ACLOCAL = ${SHELL} /root/catswin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/catswin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/catswin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/catswin/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /root/catswin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = CATSCOIN Core
PACKAGE_STRING = CATSCOIN Core 1.0.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/catswin
abs_srcdir = /root/catswin
abs_top_builddir = /root/catswin
abs_top_srcdir = /root/catswin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/catswin/build-aux/install-sh
