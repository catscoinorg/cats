...
- [Development guidelines](#development-guidelines)
    - [General CATSCOIN Core](#general-catscoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
CATSCOIN Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
CATSCOIN Core is a multi-threaded application, and deadlocks or other
...
However, in open source software such as CATSCOIN Core, where everyone uses
...
pay attention to for reviewers of CATSCOIN Core code.

General CATSCOIN Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CATSCOIN Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against CATSCOIN Core so that they can be integrated
